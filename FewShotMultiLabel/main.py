...
def main():
    ...
    if opt.do_train:
        ...
        train_features, train_label2id, train_id2label, \
        dev_features, dev_label2id, dev_id2label = [None] * 6
    ...
    if opt.do_predict:
        test_features, test_label2id, test_id2label = get_testing_data_feature(
